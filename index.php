...
<body>
                ...
                <div class="flex items-center">
                    <div class="dropdown">
                        ...
                        <div class="flex items-center justify-center gap-6">
                            ...
                            <img onclick="toggleCartMenu()" class="dropbtn color-black cursor-pointer w-9  h-9 object-contain sm:block sm:mr-1  " src="src/images/cart.png" alt="" />
                        </div>
    ...
    <?php if(isset($_SESSION['admin_name']) || isset($_SESSION['administrator_name']) ) : ?>

        <div class="bg-[#bdff72] h-[5vh] border-y border-black flex items-center justify-center">
        <div class="hidden md:text-center md:text-black md:block">
            <p>© 2023 O'PEP. All Rights Reserved.</p>
        </div>
        <div class="text-center text-black md:hidden  ">
